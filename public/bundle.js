...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: "videoSearch",
    value: function videoSearch(searchQuery) {
      var _this2 = this;

      (0, _youtubeApiSearch2.default)({ key: YOUTUBE_API_KEY, term: searchQuery }, function (videosData) {
        _this2.setState({
          videos: videosData,
...
},{"./components/searchBar":18,"./components/videoDetail":19,"./components/videoList":20,"lodash":14,"youtube-api-search":16}],18:[function(require,module,exports){
"use strict";
...
var VideoDetail = function VideoDetail(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "video" },
      React.createElement("iframe", { src: videoURL })
    ),
    React.createElement(
      "div",
      { className: "details" },
...
},{"./videoListItem":21}],21:[function(require,module,exports){
"use strict";
...
var VideoListItem = function VideoListItem(props) {
  ...
  var videoURL = "https://www.youtube.com/watch?v=" + props.video.id.videoId;
